          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text(S.of(context).PAGE_INTRO_OPTION1),
              ),
              const Gap(4),
              ListTile(
                contentPadding: EdgeInsets.zero,
                ...
                textColor: Colors.white,
                title: Text(S.of(context).PAGE_INTRO_OPTION2),
              ),
              const Gap(4),
              ListTile(
                contentPadding: EdgeInsets.zero,
                ...
                textColor: Colors.white,
                title: Text(S.of(context).PAGE_INTRO_OPTION3),
              ),
              const Gap(4),
              ListTile(
                contentPadding: EdgeInsets.zero,
                ...
                textColor: Colors.white,
                title: Text(S.of(context).PAGE_INTRO_OPTION4),
              ),
              const Spacer(),

...
const TaskSchema = CollectionSchema(
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'DueDate': DueDateSchema},
  getId: _taskGetId,
...
int _taskEstimateSize(
  ...
  var bytesCount = offsets.last;
  {
    ...
    if (value != null) {
      bytesCount += 3 +
          DueDateSchema.estimateSize(value, allOffsets[DueDate]!, allOffsets);
    }
  }
...
void _taskSerialize(
  ...
  writer.writeObject<DueDate>(
    offsets[1],
    allOffsets,
    DueDateSchema.serialize,
    object.dueDate,
  );
...
Task _taskDeserialize(
  ...
  final object = Task(
    ...
    dueDate: reader.readObjectOrNull<DueDate>(
      offsets[1],
      DueDateSchema.deserialize,
      allOffsets,
    ),
...
P _taskDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readObjectOrNull<DueDate>(
        offset,
        DueDateSchema.deserialize,
        allOffsets,
      )) as P;
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  QueryBuilder<Task, Task, QAfterFilterCondition> createAtIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> createAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> createAtEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> createAtGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> createAtLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> createAtBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> isCompletedGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> isCompletedLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> isCompletedBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskQueryObject on QueryBuilder<Task, Task, QFilterCondition> {
  QueryBuilder<Task, Task, QAfterFilterCondition> dueDate(
      FilterQuery<DueDate> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'dueDate');
    });
  }
}
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  QueryBuilder<Task, Task, QAfterSortBy> sortByCreateAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createAt', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByCreateAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  QueryBuilder<Task, Task, QAfterSortBy> thenByCreateAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createAt', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByCreateAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createAt', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  QueryBuilder<Task, Task, QDistinct> distinctByCreateAt() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, DateTime?, QQueryOperations> createAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createAt');
    });
  }

  QueryBuilder<Task, DueDate?, QQueryOperations> dueDateProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, DateTime?, QQueryOperations> isCompletedProperty() {
    return QueryBuilder.apply(this, (query) {
...
const DueDateSchema = Schema(
  name: r'DueDate',
  id: -4065670565051197232,
  properties: {
    ...
    r'isReminder': PropertySchema(
      id: 1,
      name: r'isReminder',
      type: IsarType.bool,
    )
  },
  estimateSize: _dueDateEstimateSize,
  serialize: _dueDateSerialize,
  deserialize: _dueDateDeserialize,
  deserializeProp: _dueDateDeserializeProp,
);

int _dueDateEstimateSize(
  DueDate object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
...
void _dueDateSerialize(
  ...
  writer.writeBool(offsets[1], object.isReminder);
}

DueDate _dueDateDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  final object = DueDate(
    ...
    isReminder: reader.readBoolOrNull(offsets[1]) ?? false,
  );
  return object;
}

P _dueDateDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension DueDateQueryFilter
    on QueryBuilder<DueDate, DueDate, QFilterCondition> {
  QueryBuilder<DueDate, DueDate, QAfterFilterCondition> dateIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'date',
      ));
  ...
  QueryBuilder<DueDate, DueDate, QAfterFilterCondition> dateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'date',
      ));
  ...
  QueryBuilder<DueDate, DueDate, QAfterFilterCondition> dateEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'date',
  ...
  QueryBuilder<DueDate, DueDate, QAfterFilterCondition> dateGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DueDate, DueDate, QAfterFilterCondition> dateLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DueDate, DueDate, QAfterFilterCondition> dateBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<DueDate, DueDate, QAfterFilterCondition> isReminderEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isReminder',
        value: value,
      ));
    });
  }
